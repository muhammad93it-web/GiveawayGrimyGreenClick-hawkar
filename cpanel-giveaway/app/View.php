...
final class View
{
    ...
    public static function dashboard(): void
    {
        ...
        if (self::$english) {
            ...
            echo '<hr><h2>Facebook Reel</h2><p class="muted">Verify a Reel belongs to this Page, then select it as the giveaway post. Selection and comment checks do not change the current giveaway.</p><label>Reel URL<input id="reel-url" type="url" placeholder="https://www.facebook.com/reel/123456789"></label><button id="select-reel" class="button secondary">Select Reel as post</button><button id="check-reel" class="button secondary">Check Reel comments</button><pre id="reel-note" class="muted" style="max-width:100%;white-space:pre-wrap;overflow-wrap:anywhere;word-break:break-word"></pre></article>';
        ...
        echo '<hr><h2>Facebook Reel</h2><p class="muted">سەرەتا خاوەنداریی Reel بۆ ئەم پەیجە پشتڕاست بکەرەوە، پاشان وەک پۆستی خەڵات هەڵیبژێرە. تەنها هەڵبژاردن و پشکنین خەڵاتی ئێستا ناگۆڕن.</p><label>لینکی Reel<input id="reel-url" type="url" placeholder="https://www.facebook.com/reel/123456789"></label><button id="select-reel" class="button secondary">هەڵبژاردنی Reel وەک پۆست</button><button id="check-reel" class="button secondary">پشکنینی کۆمێنتەکانی Reel</button><pre id="reel-note" class="muted" style="max-width:100%;white-space:pre-wrap;overflow-wrap:anywhere;word-break:break-word;direction:rtl;text-align:right"></pre></article>';

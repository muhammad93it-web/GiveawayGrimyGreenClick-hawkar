...
final class View
{
    ...
    public static function dashboard(): void
    {
        ...
        echo '<article class="card results"><div class="result-head"><h2>ڕیزبەندی</h2><span id="totals" class="badge">٠ کۆمێنت</span></div><ol id="participants" class="ranking"></ol></article>';
        echo '</section>';
        self::footer();
    }
